...
<!-- Custom CSS -->
<link href="<%=path%>/css/search/search.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<div id="wrapper">
		<!-- Navigation Bar -->
							...
							<div class="panel-body">
								<div class="col-xs-offset-1 col-xs-10 center big-marged-top">
									<div class="rd-search-group">
										...
										<label for="rdSearchGoogle" class="rd-search-google"><img src="<%=path%>/img/search/logo-google.png" alt="Google" /></label>
									</div>
									<div class="rd-search-group">
										<input id="rdSearchYouTube" type="radio" name="searchFilter" value="youtube">
										<label for="rdSearchYouTube" class="rd-search-youtube"><img src="<%=path%>/img/search/logo-youtube.png" alt="YouTube" /></label>
									</div>
									<div class="rd-search-group">
										<input id="rdSearchAmazon" type="radio" name="searchFilter" value="amazon">
										<label for="rdSearchAmazon" class="rd-search-amazon"><img src="<%=path%>/img/search/logo-amazon.png" alt="Amazon" /></label>
									</div>
								</div>

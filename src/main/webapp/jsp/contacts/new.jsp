								...
								<form id="contactForm" action="contacts" method="post">
									...
									<div class="col-xs-12 col-sm-offset-1 col-sm-5 big-marged-top">
										<div class="inputWithIcon">
											<input id="textFirstname" name="firstname" type="text" placeholder="<fmt:message key="global.firstname" />" pattern=".{1,30}" title="<fmt:message key="help.1.30" />" autofocus required>
											<i class="fas fa-user fa-fw" aria-hidden="true"></i>
										</div>
									</div>
									<div class="col-xs-12 col-sm-5 big-marged-top">
										<div class="inputWithIcon">
											<input id="textLastname" name="lastname" type="text" placeholder="<fmt:message key="global.lastname" />" pattern=".{1,30}" title="<fmt:message key="help.1.30" />">
											<i class="fas fa-user fa-fw" aria-hidden="true"></i>
										</div>
									</div>
									<div class="col-xs-12 col-sm-offset-1 col-sm-5 big-marged-top">
										<div class="inputWithIcon">
											<input id="textEmail" name="email" type="email" placeholder="<fmt:message key="global.email.example" />" maxlength="50" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" title="<fmt:message key="help.6.50" />">
											<i class="fas fa-envelope fa-fw" aria-hidden="true"></i>
										</div>
									</div>
									<div class="col-xs-12 col-sm-5 big-marged-top">
										<div class="inputWithIcon">
											<input id="textTwitter" name="twitter" type="text" placeholder="<fmt:message key="global.twitter" />" pattern=".{1,30}" title="<fmt:message key="help.1.30" />">
